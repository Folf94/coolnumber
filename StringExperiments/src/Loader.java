...
public class Loader {
    ...
    public void largeText(String largeText) {
         String a = largeText.replaceAll("[^а-яА-Я a-zA-Z]", "");
        System.out.println(a);
        System.out.println();
    }

    public void sumOfDigits(String text) {
    ...
    public static void main(String[] args) {
        ...
        String largeText = "Meet my family. There are five of us – my parents, my elder brother, my baby sister and me.  " +
        ...
        loader.sumOfDigits(text);
        System.out.println("++++++++++++++++++++++++++++++++++");
        loader.yourFio();
        System.out.println("++++++++++++++++++++++++++++++++++");
        String phone = "+7 909 123-45-67";
        System.out.println(phone.replaceAll("[^0-9]", ""));
        System.out.println("++++++++++++++++++++++++++++++++++");
        loader.largeText(largeText);
